        ...
        <header className="cookie-gradient border-b-4 border-orange-400 shadow-lg">
          <div className="container mx-auto px-6 py-6">
            <div className="flex items-center justify-between">
              {/* Minecraft Logo - Left Side - Small Logo Only */}
              <Button
                onClick={() => copyToClipboard('cookiemc.vaulthosting.in', 'Server IP')}
                className="minecraft-button text-white p-1 rounded shadow-md hover:scale-105 transition-transform"
              >
                <img 
              ...
              {/* CookieMC Logo - Center - Biggest Element */}
              <div className="text-center">
                <img 
                  src="https://dunb17ur4ymx4.cloudfront.net/webstore/logos/9a6b330d3562ceea74782a8b93a0505c15a8305c.png" 
                  alt="CookieMC Logo" 
                  className="w-48 h-48 mx-auto rounded-lg shadow-xl border-4 border-white hover:scale-105 transition-transform"
                />
              </div>

              {/* Discord Logo - Right Side - Small Logo Only */}
              <Button
